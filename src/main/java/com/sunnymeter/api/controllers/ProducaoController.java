...
import com.sunnymeter.api.models.registro.producao.DadosCadastroProducao;
import com.sunnymeter.api.models.registro.producao.DadosDetalhamentoProducao;
import com.sunnymeter.api.models.registro.producao.Producao;
import com.sunnymeter.api.models.registro.producao.ProducaoRepository;
...
public class ProducaoController {
	...
	public ResponseEntity find(@PathVariable UUID registro_producao_uuid) {
		var producao = repository.findById(registro_producao_uuid)
				.orElseThrow(() -> new IllegalArgumentException("Registro de produção não encontrada: " + registro_producao_uuid));
